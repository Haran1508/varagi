...
//      ConstantValues.IS_ADMOBE_ENABLED = true;
    ...
    private void setAppConfig() {
        ...
        if (appSettingsDetails != null) {
            ...
            ConstantValues.CURRENCY_CODE = "INR";
...
//                ConstantValues.APP_HEADER = appSettingsDetails.getAppName();
          ...
          /*  myAppPrefsManager.setCurrencyCode(value);
            ...
            ConstantValues.CURRENCY_SYMBOL = Utilities.getCurrencySymbol(myAppPrefsManager.getCurrencyCode());*/
