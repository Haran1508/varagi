package com.varagifoods.customer.models.order_model;
...
public class OrderDetails implements Parcelable
{
    ...
    protected OrderDetails(Parcel in) {
        ...
        this.couponAmount = ((long) in.readValue((long.class.getClassLoader())));
    ...
    public OrderDetails withCouponAmount(long couponAmount) {
        this.couponAmount = couponAmount;
        return this;
    }
